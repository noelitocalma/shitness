...
.controller('SubjectsCtrl', function($scope, $stateParams) {
  $scope.courseName = $stateParams.courseName
  $scope.subjects = getCourse($scope.courseName).subjects || [];
})
...
.controller('ReviewCtrl', function($scope, $stateParams) {
  ...
  $scope.questions = shuffle(getQuestions(courseName, subjectName))
...
.controller('QuizCtrl', function($scope, $stateParams, $interval) {
  var courseName = $scope.courseName = $stateParams.courseName
  var subjectName = $scope.subjectName = $stateParams.subjectName
...
function getCourse(acronym) {
  return courses.find(function(course) {
    return course.acronym === acronym;
  });
}

function getQuestions(courseName, subjectName) {
  var subject = getCourse(courseName).subjects;
